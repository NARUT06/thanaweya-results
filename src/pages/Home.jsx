...
export default function Home() {
    ...
    return (
        <div className="min-h-screen flex flex-col bg-gradient-to-b from-emerald-50/50 to-white dark:from-slate-900 dark:to-slate-950 transition-colors">
            ...
            <main className="px-4 pb-20 flex-1">
